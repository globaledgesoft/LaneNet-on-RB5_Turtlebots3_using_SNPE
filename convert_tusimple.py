...
def generate_segmentation_and_train_list(root, line_txt, names):
    ...
    """
    train_gt_fp = open(os.path.join(root,'/Path_to_Dataset/train_set/train_gt.txt'),'w')
